...
@Component({
  selector: 'loading-location-dialog',
  templateUrl: 'loading-location.dialog.html',

})
export class LoadingLocationDialog extends ModalBaseClass implements OnInit {
  form: FormGroup;
  constructor(
    public dialogRef: MatDialogRef<LoadingLocationDialog>,
